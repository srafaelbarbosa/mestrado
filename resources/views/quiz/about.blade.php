...
<html lang="en">
  ...
  <head>
    ...
    <title>Sobre - Equipe Desenvolvedora</title>
  ...
  <body>
    ...
    <!-- Page Header -->
    <header class="masthead" style="background-image: url({{ url('/img/about.jpeg')}});">
      ...
      <img class="rounded mx-auto d-block" src="{{ url('/img/rhurick.jpg')}}">
        ...
        <div class="row">
          <div class="col-lg-8 col-md-10 mx-auto">
            <ul class="list-inline text-center">
              <li class="list-inline-item">
                <a href="https://twitter.com/RhurickC" target="_blank">
                  <span class="fa-stack fa-lg">
                    <i class="fas fa-circle fa-stack-2x"></i>
                    <i class="fab fa-twitter fa-stack-1x fa-inverse"></i>
                  </span>
              ...
              <li class="list-inline-item">
                <a href="https://www.facebook.com/rhurick" target="_blank">
                  <span class="fa-stack fa-lg">
                    <i class="fas fa-circle fa-stack-2x"></i>
                    <i class="fab fa-facebook-f fa-stack-1x fa-inverse"></i>
                  </span>
